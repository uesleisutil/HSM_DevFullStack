...
public class EdFisica {
    public static void main(String[] args) {
        List <String> nome_estudante  = new ArrayList<>();
        List <Float> idade_estudante  = new ArrayList<>();
        List <Float> altura_estudante = new ArrayList<>();
        List <Float> peso_estudante   = new ArrayList<>();
